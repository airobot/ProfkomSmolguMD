package profkomsmolgu.smolgu.ru.profkomsmolgu.ldrawer;
...
public class DrawerArrowDrawable extends Drawable {
	/**
	 * Joins two {@link android.graphics.Path}s as if they were one where the first 50% of the
	...
	/**
	 * Draws a line between two {@link profkomsmolgu.smolgu.ru.profkomsmolgu.ldrawer.DrawerArrowDrawable.JoinedPath}s at distance
	...
	private class BridgingLine {
		 ...
		 * protruding ends drawn for {@link android.graphics.Paint.Cap#ROUND} style lines.
		 */
	 ...
	 * {@link profkomsmolgu.smolgu.ru.profkomsmolgu.ldrawer.DrawerArrowDrawable#PATH_GEN_DENSITY}.
	 */
	 ...
	 * {@link DrawerListener#onDrawerSlide(android.view.View, float)}'s {@code slideOffset}
	 * parameter.
	 */
	 ...
	 * {@link profkomsmolgu.smolgu.ru.profkomsmolgu.ldrawer.DrawerArrowDrawable#PATH_GEN_DENSITY}, no scaling needs to be
	 * done.
	 */
